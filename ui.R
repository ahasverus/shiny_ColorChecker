  ...
  fluidPage(
    ...
    fluidRow(
      ...
      column(4,#3
        ...
        div(img(src = "./data/ColorChecker_corners.png", height = 180, width = 120, align = "center"), style="text-align: center;"),
        h3(),
      ...
      #   plotOutput("OriginalImage1", click = "plot_click", height = "500px"), # 800
      #   conditionalPanel(condition = "output.calibrated" , h3("Calibrated image")),
      #   plotOutput("OriginalImage2", height = "500px")
      # )
      column(4,
        conditionalPanel(condition = "output.fileUploaded" , h3("")),
        conditionalPanel(condition = "output.exampleloaded" , h3("")),
        plotOutput("OriginalImage1", click = "plot_click", height = "500px") # 800
      ),
      column(4,
        conditionalPanel(condition = "output.calibrated" , h3("")),
        plotOutput("OriginalImage2", height = "500px")
      )
    )
  )
